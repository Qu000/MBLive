...
- (void)setRelateLive:(MBHomeLiveModel *)relateLive{
...
- (void)didFinish
{
    ...
    [[MBNetworkTool shareTool] GET:self.live.flv parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
