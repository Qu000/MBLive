...
@protocol MBBannerViewDelegate <NSObject>
...
/*
 ...
 搜索"MBPlaceholder"替换为你想要显示的图片名称，或者将原有的占位
 图片删除并修改你想要显示的图片名称为"MBPlaceholder"。
 不需要占位图片的请将[UIImage imageNamed:@"MBPlaceholder"]
 ...
 *  代理，用来处理图片的点击
 */
@property (nonatomic, weak) id<MBBannerViewDelegate> delegate;
